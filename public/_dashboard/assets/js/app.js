  ...
  function t(e) {
    1 == n("#light-mode-switch").prop("checked") && "light-mode-switch" === e
      ? (n("html").removeAttr("dir"),
        ...
        n("#bootstrap-style").attr("href", window.location.protocol + "//" +window.location.host +"/_dashboard/assets/css/bootstrap.min.css"),
        n("#app-style").attr("href", window.location.protocol + "//" +window.location.host +"/_dashboard/assets/css/app.min.css"),
        sessionStorage.setItem("is_visited", "light-mode-switch"))
      : 1 == n("#dark-mode-switch").prop("checked") && "dark-mode-switch" === e
      ? (n("html").removeAttr("dir"),
        n("#light-mode-switch").prop("checked", !1),
        n("#rtl-mode-switch").prop("checked", !1),
        n("#bootstrap-style").attr("href", window.location.protocol + "//" +window.location.host +"/_dashboard/assets/css/bootstrap-dark.min.css"),
        n("#app-style").attr("href", window.location.protocol + "//" +window.location.host +"/_dashboard/assets/css/app-dark.min.css"),
        sessionStorage.setItem("is_visited", "dark-mode-switch"))
      : 1 == n("#rtl-mode-switch").prop("checked") &&
        "rtl-mode-switch" === e &&
        (n("#light-mode-switch").prop("checked", !1),
        n("#dark-mode-switch").prop("checked", !1),
        n("#bootstrap-style").attr("href", window.location.protocol + "//" +window.location.host +"/_dashboard/assets/css/bootstrap-rtl.min.css"),
        n("#app-style").attr("href", window.location.protocol + "//" +window.location.host +"/_dashboard/assets/css/app-rtl.min.css"),
        n("html").attr("dir", "rtl"),
